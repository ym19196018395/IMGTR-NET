...
PATCHMATCHNET_DIR="${PATCHMATCHNET_DIR:-/home/ym/Experiment/Code/PatchmatchNet-new}"

# 外部 GeoMVSNet 源码根目录 (服务器实际路径)
GEOMVSNET_DIR="${GEOMVSNET_DIR:-/home/ym/Experiment/Code/GeoMVSNet-master}"

# GeoMVSNet 预训练模型权重 (.ckpt)
DEFAULT_CKPT="${GEOMVSNET_DIR}/checkpoints/model_000015.ckpt"
CKPT_FILE="${1:-$DEFAULT_CKPT}"

# WHU 数据集根目录与测试切片列表
MVS_TESTING="${MVS_TESTING:-/home/ym/Experiment/Datas/WHU_MVS_dataset}"
TEST_LIST="${TEST_LIST:-lists/whu/minitest.txt}"
