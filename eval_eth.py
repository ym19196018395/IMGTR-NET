...
if __name__ == '__main__':
    ...
    if args.split == "test":
        ...
        # ym_add 进行简单的练习
        scans_mini = ['facade']
        geo_mask_thres_mini={'facade':4}
        num_images={'facade':76}
        for scan in scans_mini:
            start_time = time.time()
            ...
            filter_depth(scan_folder, out_folder, os.path.join(args.outdir, scan + '.ply'),
                        args.geo_pixel_thres, args.geo_depth_thres, args.photo_thres, img_wh, geo_mask_thres_mini[scan])
